...
#    """All public objects in the internal API are exposed under `templateer2`."""
#    not_exposed = [
#        obj.path
#        for obj in modulelevel_internal_objects
#        if obj.name not in templateer2.__all__ or not hasattr(templateer2, obj.name)
#    ]
...
def test_single_locations(public_api: griffe.Module) -> None:
    ...
    multiple_locations = {}
    for obj_name in templateer2.__all__:
...
def test_inventory_matches_api(
    ...
    public_api_paths.add("templateer2")
